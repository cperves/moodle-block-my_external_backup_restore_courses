...
Feature:
  ...
  Background:
    ...
    And the following config values are set as admin:
      ...
      | onlyoneremoteinstance | 0 |block_my_external_backup_restore_courses|
  ...
  @javascript
  Scenario: Test that if a course is even restored nby teacher1 , teacher2 can restore it
    ...
    And the ".admintable tbody tr:nth-child(2) td.c1 input[name='selectedcourses[]']" "css_element" should be enabled
