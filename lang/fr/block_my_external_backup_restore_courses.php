...
$string['success_mail_main_message'] = 'La restauration du cours "{$a->externalcoursename}" depuis la plate-forme moodle {$a->externalmoodle} vers la plate-forme moodle {$a->localmoodle} a été effectuée avec succès.\nAttention ce cours a été restauré sans données utilisateur.';
$string['success_mail_main_message_withuserdatas'] = 'La restauration du cours "{$a->externalcoursename}" depuis la plate-forme moodle {$a->externalmoodle} vers la plate-forme moodle {$a->localmoodle} a été effectuée avec succès.\nCe cours a été restauré avec les données utilisateur.';
$string['cantrestorecourseincategorycontext'] = 'L\'utilisateur {$a->username} ne pas restaurer le cours "{$a->externalcoursename}" dans la catégorie "{$a->internalcategoryname}" car il n\'a pas la capacité moodle/course:create.\n Le cours serra restauré dans la categorie "{$a->defaultcategoryname}".';
...
$string['enrolmentmodeheadtable'] = 'Restauration des méthodes d\'inscription';
$string['adminrestorecourseforuser'] = 'Restaurer un cours pour un utilisateur';
$string['withuserdatas'] = 'Avec les données utilisateur';
$string['enrolmentmode'] = 'Mode de restauration des méthodes d\'inscription';
...
$string['notcourseowner'] = 'Vous n\'êtes pas inscrit dans ce cours avec le bon rôle.';
$string['autoenrol_requester'] = 'Inscrire automatiquement le demandeur';
...
$string['course_restoration_task'] = 'Entité tâche de restauration de cours';
$string['my_external_backup_restore_courses:change_status'] = 'L\'utilisateur a la possibilité de changer le statut de la têche de restauration du cours';
...
$string['externalmoodleurl'] = 'Url du Moodle distant';
$string['internalcategory'] = 'Id de la catégorie interne';
$string['timecreated'] = 'Date de création';
$string['timemodified'] = 'Date de modification';
$string['timescheduleprocessed'] = 'Date de programmation';
$string['scheduledstatus'] = 'Programmé';
$string['inprogressstatus'] = 'En cours';
$string['performedstatus'] = 'Effectué';
$string['errorstatus'] = 'Erreur';
$string['managetasks'] = 'Gérer les tâches programmées';
$string['status'] = 'Statut';
$string['id'] = 'Id';
$string['shortnameXfullname'] = '{$a->id} {$a->fullname} ({$a->shortname}) ';
$string['withuserdatas_true'] = 'Oui';
$string['withuserdatas_true'] = 'Non';