...
$string['NA'] = 'N/A';
$string['authorizeremoterepositoryrestore']='Authorize restore for files whom source is not local or course files';
$string['authorizeremoterepositoryrestore_desc']='Authorize restore for files whom source is not local or course files';
$string['repositorytypestorestore'] = 'repository types to restore';
$string['repositorytypestorestore_desc'] = 'repository types to restore';
...
$string['onlyoneremoteinstance']='Only one restoration is autorized by external course';
$string['onlyoneremoteinstance_desc']='Only one restoration is autorized by external course. All users included';
