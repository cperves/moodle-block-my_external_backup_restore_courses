...
$string['success_mail_main_message'] = 'course restoration "{$a->externalcoursename}" from moodle platform {$a->externalmoodle} to moodle platform {$a->localmoodle} completed successfully.\nWarning this course had been restored without user datas.';
$string['success_mail_main_message_withuserdatas'] = 'course restoration "{$a->externalcoursename}" from moodle platform {$a->externalmoodle} to moodle platform {$a->localmoodle} completed successfully.\ntTis course had been restored with user datas.';
...
$string['enrolmentmodeheadtable'] = 'Enrolment mode';
...
$string['nomoreexistingrestoredcourse'] = 'Deleted restored course';
$string['courseidXbutdeleted'] = '{$a} (deleted)';
$string['notcourseowner'] = 'You are not enrolled into course with the correct role';
$string['autoenrol_requester'] = 'Auto enrol requester';
$string['autoenrol_requester_desc'] = 'Auto to enrol requester with defined enrol role.';
$string['moodle_role'] = 'Moodle course mode';
$string['moodle_role_desc'] = 'Is this Moodle is a course server, a course client or both of them.';
$string['courseclient'] = 'Course client';
$string['courseserver'] = 'Course server';
$string['bothclientserver'] = 'Both course and client server';
$string['source'] = 'Source';
$string['course_restoration_task'] = 'Course restoration entity';
$string['my_external_backup_restore_courses:change_status'] = 'User has the possibility to change status of course restoration task.';
$string['my_external_backup_restore_courses:change_internalcategory_id'] = 'User has the possibility to change internalcategory id of  course restoration task.';
$string['my_external_backup_restore_courses:change_userid'] = 'User has the possibility to change userid of  course restoration task.';
$string['my_external_backup_restore_courses:restore_courses_for_users'] = 'User has the possibility to restore course for other users.';
$string['courseid'] = 'Course Id';
$string['externalcoursename'] = 'Remote Course name';
$string['externalcourseid'] = 'Remote course id';
$string['userid'] = 'User id';
$string['externalmoodleurl'] = 'Remote Moodle url';
$string['internalcategory'] = 'internal category id';
$string['timecreated'] = 'Time created';
$string['timemodified'] = 'Time modified';
$string['timescheduleprocessed'] = 'Time scheduled processed';
...
$string['backuprestorecourseadmin'] = 'Restore course from remote Moodle administration';